...
<p align="center">
  <a href="https://devtools.at/tools/gradient-generator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
...
<p align="center">
  <b>Generate CSS gradient code</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/gradient-generator">Try Online</a> •
...
**[Try CSS Gradient Generator online at DevTools.at →](https://devtools.at/tools/gradient-generator)**
...
Generate CSS gradient code. This is a standalone TypeScript/JavaScript implementation that you can use in your own projects.
...
```typescript
import { process } from '@devtools-at/gradient-generator';
